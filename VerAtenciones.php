                ...
                <div class="container">
                    ...
                    <div class="text-center">
                        <div class="col-lg-12 center-block">
                            <h3 style="color: #000000"><b>Listado de Atenciones</b></h3>
                                <table class="table table-hover active" id="tablaFormastoA">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            $row = $oListado->ListarAtencion();
                                            if(count($row)>=1){
                                                foreach ($oListado->ListarAtencion() as $oElemento) { ?>
                                                <tr>
                                                ...
                                                echo "<table><tr><td><div>". "No hay registros de Atenciones." ."</div></td></tr></table>";
                                            }
                                            ?>
                                    </tbody>
                                </table>
